...
public class RootCommand extends ParsedCommand {
    ...
    // As of now, there's nothing different other than the name!
    ...
    public RootCommand(String name, String description, String longDescription,
        ...
        super(name, description, longDescription, permissions, arguments, children);
    }

    public RootCommand(String name, String description, String longDescription,
        String[] permissions) {
        super(name, description, longDescription, permissions);
    }
